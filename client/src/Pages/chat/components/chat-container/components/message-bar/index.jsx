...
const MessageBar = () => {
    ...
    return (
        <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-4 mb-6 gap-6 ">
            <div className="flex-1 flex bg-[#2a2b33] rounded-md items-center hap-5 pr-5">
                ...
                <input type="file" name="" className="hidden" ref={fileInputRef} onChange={handleAttachmentChange} id="" />
